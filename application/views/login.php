...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | HOAN XA CO.,LTD. ' . $this->config->item('application_version')  . ' | ' .  $this->lang->line('login_login'); ?></title>
...
<body>
	<div id="logo" align="center"><img src="<?php echo base_url();?>/images/logo1.jpg"></div>
	...
	<div id="login">
		...
		<h1>HOAN XA Co., Ltd.<?php echo $this->config->item('application_version'); ?></h1>
